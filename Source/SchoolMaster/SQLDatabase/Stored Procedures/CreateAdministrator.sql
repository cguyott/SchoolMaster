    ...
    BEGIN TRY
        ...
        BEGIN
            BEGIN TRANSACTION
                ...
                SELECT @AdministratorId = [Id] FROM [dbo].[Administrator] WHERE [PersonId] = @PersonId;
        ...
        ELSE
        BEGIN
            SET @Results = 1;  -- Indicates that this administrator already exists.
        END
    END TRY
    BEGIN CATCH
        IF (@@TRANCOUNT > 0)
